...
<div class="container">
  ...
  <form name="CreateNewUserForm" action="CreateNewUserServlet" onsubmit="return validateForm()" method="POST">
      ...
      <button  class="btn btn-primary btn-lg" name="submit" type="submit">Sign Up!</button></div></center>
   </form>

        <div class = "col-sm-9"><left>
          <div class="aboutButton"><a href="loginPage.jsp"><button style="margin-top: 5px;margin-bottom: 5px;" type = "button" class = "btn btn-danger btn-lg">Cancel</button></a>
          </div></left>
        </div>
      </div>
