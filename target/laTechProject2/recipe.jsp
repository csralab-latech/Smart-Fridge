        						...
        						<img class="img-responsive" src="${invRec[loop1.index+loop2.index].imageURL}">
          							<hr />
          								...
          								<div style="text-align:center; width:100%;">
          									<iframe width="640" height="360" src="${invRec[loop1.index+loop2.index].youtubeLink}" frameborder="0" allowfullscreen></iframe>
          								</div>
        						</div>
      						...
      						<div class="modal-content">
        						...
        						<img class="img-responsive" src="${recipes[loop1.index+loop2.index].imageURL}">
          							<hr />
          								...
          								<hr/>
          								<div style="text-align:center; width:100%;">
          									<iframe width="640" height="360" src="${recipes[loop1.index+loop2.index].youtubeLink}" frameborder="0" allowfullscreen></iframe>
          								</div>
        						</div>
        						<div class="modal-footer">
          						<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
