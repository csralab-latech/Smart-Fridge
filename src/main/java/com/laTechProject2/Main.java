...
public class Main {//138.47.200.54		10.0.0.37
	public static final String URL = "jdbc:mysql://10.0.0.37:3306/LTR_Fridgedb?zeroDateTimeBehavior=convertToNull&autoReconnect=true&characterEncoding=UTF-8&characterSetResults=UTF-8";// I have copied the url from the google hangout --Nick
	static final String USERNAME = "nah012"; //This is my username and password please don't hack
	static final String PASSWORD = "P92Y"; //my Jira to find all of that sensitive data. --Nick
