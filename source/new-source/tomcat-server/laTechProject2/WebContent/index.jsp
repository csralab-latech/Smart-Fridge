...
<html>	<head>
	...
	<body>
		...
		<div class="container">
		  <div class="jumbotron">
		    <h1>Welcome to Smart Refrigerator!</h1>      
		...
		<div class = "buttons">
			...
			<div class = "row">
				...
				<div class = "col-sm-4"><center>
					<div class="loginButton"><a href="Inventory.jsp"><button type = "button" class = "btn btn-primary btn-lg"><span class="glyphicon glyphicon-check"></span></button></a>
					<p align="middle"><br>  Inventory  </p>
					</div></center>
				</div>

				<div class = "col-sm-4"><center>
					<div class="newAccountButton"><a href="shoppingList.jsp"><button type = "button" class = "btn btn-success btn-lg"><span class="glyphicon glyphicon-shopping-cart"></span></button></a>
					<p align="middle"><br>Shopping List</p>
					</div></center>
				</div>

				<div class = "col-sm-4"><center>
					<div class="aboutButton"><a href="recipe.jsp"><button type = "button" class = "btn btn-warning btn-lg"><span class="glyphicon glyphicon-cutlery"></span></button></a>
					<p align="middle"><br>Recipes</p>
					</div></center>
				</div>
