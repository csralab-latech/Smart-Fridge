...
<script>
function changeQuantity(r, SID, task) {
	var i = r.parentNode.parentNode.parentNode.rowIndex;
	var val = $('#invTab tr:nth-child(' + (i+2) + ') td:nth-child(3) div:nth-child(1)').text();
	if(task === 'increase'){
		val++;
	}else{
		val--;
	}
	r.parentNode.parentNode.children[0].textContent = val;
	$.post("InventoryServ", {ItemToChangeQuantity: SID, value: val});
	return false;
}
</script>
<script>
...
<body>
	...
	<br>
	<%@ include file="energySaver.jsp"%>
	<%@ include file="wasteCalculator.jsp"%>
							...
							<section>
								...
								<div class="table-responsive">
									<table id="invTab" class="table table-striped sortable">
										<h3 class="page-header" style="margin-top: 8px; margin-bottom: 8px;">Current Inventory</h3>										<thead>
											<tr>
