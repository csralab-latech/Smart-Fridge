...
<div class="container-fluid text-center"> <!-- Group Things -->
  ...
  <h2>Create New User</h2>
		  ...
		  <form name="CreateNewUserForm" action="CreateNewUserServlet" onsubmit="return validateForm()" method="POST">
		      ...
		      <br>
		      <div id="inputAge" class="form-group">    
		      	<input type="number" name="age" class="form-control" placeholder="Enter Age">
		     </div>
		     <br>
		     <div id="inputGender" class="form-group">    
		     ...
		     <br>
		     <div id="inputWeight" class="form-group">    
		      	<input type="number" name="weight" class="form-control" placeholder="Enter Weight in lbs">
		     </div>
			<div id="inputHeight" class="form-group">    
		      	<input type="number" name="height_feet" class="form-control" placeholder="Enter Feet">
		      	<input type="number" name="height_inches" class="form-control" placeholder="Enter Inches">
		     </div>
		      <div class = "row">
