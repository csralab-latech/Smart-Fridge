...
String urlMyAccount="myAccount.jsp";
String urlNutritionPlan="nutritionPlan.jsp";
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li id="myAccount"><a style="font-weight: bold;" href=<%=urlMyAccount%>>My Account</a></li>
            <li id="nutritionPlan"><a style="font-weight: bold;" href=<%=urlNutritionPlan%>>Nutrition</a></li>
